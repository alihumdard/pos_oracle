...
<style>
    ...
    .btn-primary-custom { background-color: #6f42c1; border-color: #6f42c1; color:white; }
        ...
        <div class="col-lg-7 col-md-9 mx-auto">
            <div class="form-container">
                 <div class="d-flex justify-content-between align-items-center mb-4">
                    <h3 class="mb-0" style="color: #6f42c1;">Edit Expense Category</h3>
                ...
                <form action="{{ route('expense_categories.update', $expenseCategory->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    @include('pages.expenses.categories._form', ['category' => $expenseCategory]) {{-- Include the form partial and pass data --}}
